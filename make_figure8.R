...
# load("make_figure8.Rdata")
# save.image("make_figure8.Rdata")

load("data/S/HB_true_pars.Rdata")
load("data/S/HB_model_pars.Rdata")
...
#pdf("Figure8.pdf", width = 15, height = 5)
par(mfrow=c(1,3))
f0t = f0xgridt
fjt = fxgridt

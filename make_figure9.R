...
fout_HBBS  = HBBS(ydata=ydata, xdata=xdata, vdata=vdata, wdata=wdata[,-1,drop=F], 
                  ...
                  iflaglm=iflaglm, nExtreme=1, shape=shape)
...
# save.image("make_figure9.Rdata")

load("data/U/HB_true_pars.Rdata")
load("data/U/HB_model_pars.Rdata")
...
#pdf("Figure9.pdf", width = 15, height = 5)
par(mfrow=c(1,3))
f0t = f0xgridt
fjt = fxgridt

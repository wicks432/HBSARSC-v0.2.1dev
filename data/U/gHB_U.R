...
Getf = function(x,fpars){
  ...
  # Min f at -log(b1/b2*b3)/b3
    
  return(f)
}
# Specify minimum and b20 and b30
xhat  = 4
b20   = 50
b30   = .5
b10   = b20*b30*exp(-b30*xhat)
xhat0 = -log(b10/(b20*b30))/b30
cat("\n Minimum of U-Shape = ",xhat0)


fpars    = list(b1=b10,b2=b20,b3=b30)
...
for(j in 1:ngroups){
  ...
  b1 = runif(1,.8*b10,1.2*b10)   
  b2 = runif(1,.8*b20,1.2*b20)     
  b3 = runif(1,.8*b30,1.2*b30) 
  
  
  fpars = list(b1=b1,b2=b2,b3=b3)
...
for(j in 1:ngroups){
  ...
  if(j <= 10){
    matplot(xgrid,bout, type="l",
            ...
            lwd=c(3,3)); 
    points(xj,rj,pch=19)
    legend("topright",legend=c("Lower f","Upper f","Parametric Residuals"),

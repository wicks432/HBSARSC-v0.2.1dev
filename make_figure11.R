...
fout_HBBS  = HBBS(ydata=ydata, xdata=xdata, vdata=vdata, wdata=wdata[,-1,drop=F], 
                  ...
                  iflaglm=iflaglm, nExtreme=3, shape=shape)
...
# save.image("make_figure11.Rdata")

load("data/MM/HB_true_pars.Rdata")
load("data/MM/HB_model_pars.Rdata")
...
#pdf("Figure11.pdf", width = 15, height = 5)
par(mfrow=c(1,3))
f0t = f0xgridt
fjt = fxgridt
